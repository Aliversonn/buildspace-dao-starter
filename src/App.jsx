...
const App = () => {
  ...
  const editionDropAddress = "0x897328a3B2cf96A6e28699fD5DFC2BF9c8D639ac"
  const { contract: editionDrop } = useContract(editionDropAddress, "edition-drop");
  // Initialize our token contract
  const { contract: token } = useContract('0xc203EC3241556937Fdc8D47B3e914c519b9C61C6', 'token');
  const { contract: vote } = useContract("0xd9B48F678853ba4aB27737bb35cAFDe6D5F79380", "vote");
